...
String url = "http://192.168.43.108/sensorr/konek.php";
...
void setup() {
    ...
    WiFi.mode(WIFI_STA);
    WiFiMulti.addAP("Poltek Harber", "poltekharber"); // Sesuaikan SSID dan password ini
...
void loop() {
    ...
    if((WiFiMulti.run() == WL_CONNECTED)) {
        ...
        // Tambahkan nilai, suhu, dan kelembaban pada URL yang sudah kita buat
        ...
        // Periksa http Code, akan bernilai negatif kalau error
        if(httpCode > 0) {
